...
import ScholarshipPanel from '../assets/img/gallery/scholarshipPanel.webp';
import HHBusinessPanel from '../assets/img/gallery/HHBusinessPanel.webp';
import UPennPanel from '../assets/img/gallery/UPennPanel.webp';
...
const Unipanel = () => {
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="d-flex flex-row align-items-center flex-wrap" style={{margin: "20px"}}>
                ...
                <img data-aos="fade-down" src={UniApp} alt="refugee image 2" srcset="" class="img-fluid rounded-3 aos-init aos-animate" width="400"></img>
              ...
              <div class="row">
                ...
                <img data-aos="fade-down" src={ScholarshipPanel} alt="scholarship panel" srcset="" class="img-fluid rounded-3 mb-5" width="400" />
                ...
                <img data-aos="fade-down" src={HHBusinessPanel} alt="upenn panel" srcset="" class="img-fluid rounded-3 mb-5" width="400" />
                ...
                <img data-aos="fade-down" src={UPennPanel} alt="upenn panel" srcset="" class="img-fluid rounded-3 mb-5" width="400" />
  ...
  return (
    <>
      <Hero 
          h1={{text: "University Information Panels!", underlined: "HomeworkHub’s", reversed: true}} 
          h2=""
          buttons={[]}
          img={Students}
      />
